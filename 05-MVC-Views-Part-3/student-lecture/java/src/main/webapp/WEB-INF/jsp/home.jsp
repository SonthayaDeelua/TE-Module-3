...
<c:import url="/WEB-INF/jsp/header.jsp">
	...
	<div class="planet">
		...
		<c:url value='/img/mercury.jpg' var='mercuryImageUrl'/>
		<img src='${mercuryImageUrl}' />
	...
	<div class="planet">
		<h2>Venus</h2>
		<c:url value='/img/venus.jpg' var='venusImageUrl'/>
		<img src='${venusImageUrl}' />
	...
	<div class="planet">
		<h2>Earth</h2>
		<c:url value='/img/earth.jpg' var='earthImageUrl'/>
	...
	<div class="planet">
		<h2>Mars</h2>
		<c:url value='/img/mars.jpg' var='marsImageUrl'/>
		<img src='${marsImageUrl}' />
	...
	<div class="planet">
		<h2>Jupiter</h2>
		<c:url value='/img/jupiter.jpg' var='jupiterImageUrl'/>
		<img src='${jupiterImageUrl}' />
